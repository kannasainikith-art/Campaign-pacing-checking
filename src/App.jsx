...
const RAW_CAMPAIGNS = [
  {
    id: "nova",
    name: "Nova Sneakers Winter Launch",
    advertiser: "Nova Athletics",
    objective: "Conversions",
    lineItems: [
      { id: "LI-01", name: "Meta Feed", audience: "US 18-34", platform: "Meta", budget: 40000, expected: 16000, spent: 10900, imp: 3808000, clicks: 68544 },
      { id: "LI-02", name: "TikTok In-Feed", audience: "US 18-24", platform: "TikTok", budget: 30000, expected: 12000, spent: 14900, imp: 5208000, clicks: 93744 },
      { id: "LI-03", name: "Google Display", audience: "Retarget", platform: "Google", budget: 25000, expected: 10000, spent: 7800, imp: 2730000, clicks: 49139 },
      { id: "LI-04", name: "Snap Ads", audience: "US 18-34", platform: "Snapchat", budget: 25000, expected: 10000, spent: 7200, imp: 2910000, clicks: 41200 },
    ],
  },
  {
    id: "aurora",
    name: "Aurora Skincare Prospecting",
    advertiser: "Aurora Beauty",
    objective: "Awareness",
    lineItems: [
      { id: "LI-01", name: "Instagram Stories", audience: "US 25-44", platform: "Meta", budget: 25000, expected: 11600, spent: 11400, imp: 2100000, clicks: 38500 },
      { id: "LI-02", name: "Pinterest Discovery", audience: "Women 25-54", platform: "Pinterest", budget: 15000, expected: 7450, spent: 6100, imp: 980000, clicks: 15200 },
      { id: "LI-03", name: "Display Prospecting", audience: "Lookalike 1%", platform: "Google", budget: 20000, expected: 8800, spent: 10400, imp: 3200000, clicks: 41000 },
      { id: "LI-04", name: "YouTube Bumper", audience: "US 18-34", platform: "YouTube", budget: 25000, expected: 9950, spent: 9000, imp: 2600000, clicks: 8200 },
    ],
  },
  {
    id: "zenith",
    name: "Zenith Auto Q1 Test Drive",
    advertiser: "Zenith Motors",
    objective: "Leads",
    lineItems: [
      { id: "LI-01", name: "Search Brand", audience: "Exact Match", platform: "Google", budget: 60000, expected: 24000, spent: 21800, imp: 1150000, clicks: 52000 },
      { id: "LI-02", name: "YouTube TrueView", audience: "In-Market Auto", platform: "YouTube", budget: 50000, expected: 18000, spent: 21200, imp: 4050000, clicks: 60500 },
      { id: "LI-03", name: "Meta Lead Gen", audience: "US 25-54", platform: "Meta", budget: 50000, expected: 23000, spent: 22300, imp: 3400000, clicks: 57000 },
      { id: "LI-04", name: "Display Remarketing", audience: "Site Visitors", platform: "Google", budget: 50000, expected: 15000, spent: 11400, imp: 2100000, clicks: 31000 },
    ],
  },
  {
    id: "kite",
    name: "Kite Cloud SaaS Free Trial",
    advertiser: "Kite Cloud",
    objective: "Signups",
    lineItems: [
      { id: "LI-01", name: "LinkedIn Sponsored", audience: "IT Decision Makers", platform: "LinkedIn", budget: 20000, expected: 9500, spent: 9200, imp: 650000, clicks: 9800 },
      { id: "LI-02", name: "Google Search Branded", audience: "Branded Terms", platform: "Google", budget: 15000, expected: 7200, spent: 7100, imp: 420000, clicks: 22000 },
      { id: "LI-03", name: "Reddit Ads", audience: "Dev Communities", platform: "Reddit", budget: 10000, expected: 5300, spent: 4000, imp: 380000, clicks: 6100 },
      { id: "LI-04", name: "X Promoted", audience: "Tech Audience", platform: "X", budget: 20000, expected: 8600, spent: 10500, imp: 910000, clicks: 12400 },
    ],
  },
  {
    id: "solstice",
    name: "Solstice Travel Summer Escape",
    advertiser: "Solstice Airlines",
    objective: "Bookings",
    lineItems: [
      { id: "LI-01", name: "Meta Feed", audience: "Destinations", platform: "Meta", budget: 20000, expected: 12000, spent: 15400, imp: 2200000, clicks: 28000 },
      { id: "LI-02", name: "Google Search", audience: "Destinations", platform: "Google", budget: 40000, expected: 20000, spent: 23000, imp: 900000, clicks: 41000 },
      { id: "LI-03", name: "YouTube TrueView", audience: "US 25-54", platform: "YouTube", budget: 50000, expected: 25000, spent: 22000, imp: 5100000, clicks: 39000 },
      { id: "LI-04", name: "TikTok Spark Ads", audience: "US 18-34", platform: "TikTok", budget: 25000, expected: 15000, spent: 20100, imp: 3600000, clicks: 52000 },
    ],
  },
];
